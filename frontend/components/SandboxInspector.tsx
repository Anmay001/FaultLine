...
export default function SandboxInspector({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-5xl h-[80vh] flex flex-col rounded-3xl glass-panel border border-zinc-800 shadow-2xl overflow-hidden bg-black">
        {/* Modal Header */}
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 flex flex-col bg-black">
            <div className="flex items-center justify-between px-4 py-2.5 border-b border-zinc-800 bg-zinc-950 text-xs">
              ...
              <button
                onClick={handleCopy}
                className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-zinc-900 hover:bg-zinc-800 text-zinc-300 hover:text-white border border-zinc-800 transition-colors font-mono text-[11px]"
              >
            ...
            <div className="flex-1 overflow-auto p-4 font-mono text-xs text-zinc-200 bg-black leading-relaxed">
              {isLoading ? (
                <div className="flex items-center justify-center h-full text-zinc-500 font-mono">
                  <span>Loading sandbox file...</span>
                </div>
              ) : (
